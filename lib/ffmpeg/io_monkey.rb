...
if RUBY_PLATFORM =~ /(win|w)(32|64)$/
  begin
    ...
    "Warning: rlovelett-ffmpeg is missing the win32-process gem to properly handle hung transcodings. Install the gem (in Gemfile if using bundler) to avoid errors."
  end
end
